...
import { Box, Grid, Typography, TextField, Button, IconButton, Autocomplete, Chip, Stack, useTheme} from "@mui/material";
import { Close } from "@mui/icons-material";
import InputMask from 'react-input-mask';

export default function AddResidantPlates(props) {
        ...
        <Grid container spacing={3} sx={{placeContent: "center"}}>
          ...
          <Grid item xs={12} align="right">
            <Autocomplete
              ...
              renderInput={(params) => (
              <TextField {...params} label={props.literals.select_zone} color="primary" size="small"/>
              )}
            />
          </Grid>
          <>
