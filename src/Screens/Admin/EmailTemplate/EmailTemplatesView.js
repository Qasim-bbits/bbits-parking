...
export default function EmailTemplatesView(props) {
    ...
    return (
      <Grid container spacing={3} sx={{placeContent: "center", py: 2}}>
        <Grid item xs={6}>
          <Typography variant="subtitle1" color="primary" className="font-bold font-gray">{props.literals.emailTemplates}</Typography>
        </Grid>
        ...
        <Grid item xs={12}>
          <Paper elevation={0} sx={{ width: '100%', overflow: 'hidden' }}>
                  ...
                  <Table aria-label="collapsible table" size="small">
                      <TableHead>
                          <TableRow>
                              ...
                              <StyledTableCell>{props.literals.template_name}</StyledTableCell>
                              <StyledTableCell>{props.literals.subject}</StyledTableCell>
                      ...
                      <TableBody>
                          ...
                          .map((row) => {
                              ...
                              return (
                                  <>
                                      <TableRow key={row.template_name}>
              ...
              <TablePagination
                  rowsPerPageOptions={[10, 25, 100, { label: 'All', value: props.emailTemplates.length }]}
                  component="div"
