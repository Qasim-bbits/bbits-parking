...
export default function AddExternalParkingConfig(props) {
        ...
        <Grid container spacing={3} sx={{placeContent: "center"}}>
          <Grid item xs={6}>
            <Typography variant="subtitle1" color="primary" className="font-bold m-2 font-gray">
              {props.btn} {props.literals.configuration}
            </Typography>
          </Grid>
          ...
          <Grid item xs={12}>
            <TextField
                ...
                label={props.literals.blinkay_ins_id}
                color="primary"
                type="text"
                name="blinkay_ins_id"
                value={props.inputField["blinkay_ins_id"]}
          ...
          <Grid item xs={12}>
            <TextField
                id="standard-error-helper-text"
                label={props.literals.blinkay_group_id}
                color="primary"
                type="text"
                name="blinkay_group_id"
                value={props.inputField["blinkay_group_id"]}
                onChange={props.handleChange}
                size="small"
                required
                fullWidth
          ...
          <Grid item xs={12}>
            <TextField
                id="standard-error-helper-text"
                label={props.literals.blinkay_tariff_id}
                color="primary"
                type="text"
                name="blinkay_tariff_id"
                value={props.inputField["blinkay_tariff_id"]}
                onChange={props.handleChange}
                size="small"
                required
                fullWidth
