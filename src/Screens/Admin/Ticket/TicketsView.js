...
export default function TicketsView(props) {
    ...
    return (
      <Grid container spacing={3} sx={{placeContent: "center", py: 2}}>
        <Grid item xs={6}>
          <Typography variant="subtitle1" color="primary" className="font-bold font-gray">{props.literals.tickets}</Typography>
        </Grid>
        <Grid item xs={6} align="right">
          <Button 
              ...
              disabled={helpers.abilityByModuleKey('ticket').can_add == false}
          >
            {props.literals.add} +
          </Button>
        </Grid>
                                  ...
                                  <>
                                      <TableRow key={row.ticket_name}>
                                          ...
                                          <TableCell>
                                              <Button 
                                                  type="button" 
                                                  disabled={helpers.abilityByModuleKey('ticket').can_delete == false}
                                              ...
                                              <Button
                                                  type="button"
                                                  disabled={helpers.abilityByModuleKey('ticket').can_edit == false}
