        ...
        <ResponsiveCard>
          ...
          {!props.resetPassword && <form onSubmit={props.handleSubmit}>
            ...
            >
              ...
              {config.url.client_url == 'park45.ca/' && <Typography fontSize='13px'>
                <a href={'https://web.park45.ca'} style={{ color: theme.palette.primary.main, textDecoration: 'none' }}>
                  {props.literals?.check_out_our_website}
                </a>
              </Typography>}
              <Box sx={{ m: 2 }} />
            </Box>
